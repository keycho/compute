...
export default function RunAI() {
  ...
  const run = useCallback(
    (raw?: string) => {
      ...
      const turn: Turn = { id, prompt: p, model, modelId, text, shown: "", meta, stage: 0, done: false };
      setTurns((t) => [...t, turn]);
          ...
          {turns.map((t) => (
            ...
            >
              ...
              <div className="glass reticle p-5">
                ...
                {t.done && (
                  <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-1 border-t border-line pt-3 font-mono text-[10.5px] uppercase tracking-[0.1em] text-mute">
                    <span>
